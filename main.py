...
train_df = pd.read_csv("auxiliary/banknote/train.csv")
test_df = pd.read_csv("auxiliary/banknote/test.csv")
ground_truth_df = pd.read_csv("auxiliary/banknote/ground_truth.csv")
